...
<ul class="art-vmenu">
	...
	<li><a href="browsemedia.php?mediatypeID=photos"><span class="l"></span><span class="r"></span><span class="t"><?php echo $text['mnuphotos']; ?></span></a></li>
	<li><a href="browsemedia.php?mediatypeID=histories"><span class="l"></span><span class="r"></span><span class="t"><?php echo $text['mnuhistories']; ?></span></a></li>
	<li><a href="browsemedia.php?mediatypeID=documents"><span class="l"></span><span class="r"></span><span class="t"><?php echo $text['documents']; ?></span></a></li>
	<li><a href="browsemedia.php?mediatypeID=videos"><span class="l"></span><span class="r"></span><span class="t"><?php echo $text['videos']; ?></span></a></li>
	<li><a href="browsemedia.php?mediatypeID=recordings"><span class="l"></span><span class="r"></span><span class="t"><?php echo $text['recordings']; ?></span></a></li>
	...
	<li><a href="browsemedia.php?mediatypeID=headstones"><span class="l"></span><span class="r"></span><span class="t"><?php echo $text['mnutombstones']; ?></span></a></li>
                ...
                <div class="art-blockcontent">
                    ...
                    <div class="art-blockcontent-body">
                		<div>
						  ...
						  <ul class="home-menus">
						<?php
							echo showLinks($tmp['t10_featurelinks']);
						?>
						  </ul>
						</div>
                        <div class="cleared"></div>
                ...
                <div class="art-blockcontent">
                    ...
                    <div class="art-blockcontent-body">
	                	<div>
						  <ul class="home-menus">
						<?php
							echo showLinks($tmp['t10_reslinks']);
						?>
						  </ul>
						</div>
						<div class="cleared"></div>
