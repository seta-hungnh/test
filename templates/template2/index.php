...
-->
						<a href="pedigree.php?personID=<?php echo $tmp['t2_pedperson']; ?>&amp;tree=<?php echo $tmp['t2_pedtree']; ?>" onmouseover="swap('pedigree','pedigreeon');" onmouseout="swap('pedigree','pedigreeoff');" class="mainlink"><img
						src="<?php echo $cms['tngpath'] . $templatepath; ?>img/pedigreeoff.gif" alt="" id="pedigree" width="162" height="24" class="noimgborder" /></a>
...
-->
						<a href="extrastree.php?personID=<?php echo $tmp['t2_phhistperson']; ?>&amp;tree=<?php echo $tmp['t2_phhisttree']; ?>" onmouseover="swap('photos','photoson');" onmouseout="swap('photos','photosoff');" class="mainlink"><img
						src="<?php echo $cms['tngpath'] . $templatepath; ?>img/photosoff.gif" alt="" id="photos" width="193" height="24" class="noimgborder" /></a>
...
?>
							...
							<tr>
								...
								<td valign="top"><a href="<?php echo $cms['tngpath']; ?>suggest.php" class="sidelink"><?php echo $text['contactus']; ?></a></td><td>&nbsp;&nbsp;&nbsp;</td>
							</tr>
							<tr>
...
?>
						...
						<div id="searchblock">
								<div id="searchtitleblock">
									<img src="<?php echo $cms['tngpath'] . $templatepath; ?>img/search.jpg" alt="Search" class="indexsearch" /><br />
...
?>
						<img src="<?php echo $cms['tngpath'] . $templatepath; ?><?php echo $tmp['t2_mainimage']; ?>" alt="" width="327" style="max-height:460px" class="noimgborder rounded10" id="mainphoto"/>
<?php
	//end MAIN IMAGE
?>
					</div>
