...
?>
	  ...
	  Note the icons <img src="<?php echo $cms['tngpath']; ?>img/photo.gif" width="14" height="12" alt="" /> for photos and <img src="<?php echo $cms['tngpath']; ?>img/doc.gif" width="11" height="13" alt="" /> for histories when they are available for an individual.</p>
