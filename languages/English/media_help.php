...
<tr class="databack">
	<td class="tngshadow">
		...
		<p><strong>(Histories only)</strong> Instead of uploading a physical file for your history, you can type or paste the text or HTML code into this box. You can
		...
		line breaks being ignored. HTML line breaks entered in the box will always be respected. If you entered your text as HTML already, or if you used the controls to create
		HTML formatting, you will probably want to leave this box unchecked.</p>
		...
		the original image as the thumbnail. If you do not already have a thumbnail, TNG can create one for you, but only if your media item is a valid JPG, GIF or PNG image.</p>
