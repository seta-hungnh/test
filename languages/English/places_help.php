...
<tr class="databack">
	<td class="tngshadow">
		...
		<p>The Geocode tool may be used to find and save latitude and longitude coordinates for Places that do not already have that information.</p>

		<span class="optionhead">Limit</span>
		<p>Depending on how many Places you have that need geocoding, this process may take a long time. For that reason, you may wish to limit the number of places you do
