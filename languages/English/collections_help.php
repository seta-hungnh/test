...
<tr class="databack">
	<td class="tngshadow">
		...
		for that specific item, the image designated here will be used as the thumbnail. The thumbnail file can located in the main TNG folder,
		or you can put it in the "img" folder along with the other standard media icons. If you put it in the "img" folder,
		you must prefix the icon file name with "img/".</p>
		...
		<p class="subheadbold">Editing/Deleting Collections</p>
