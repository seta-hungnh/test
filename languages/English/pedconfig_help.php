...
<tr class="databack">
	<td class="tngshadow">
		...
		will be shown first. The user will always have the option to switch among these display types after viewing the initial display.</p>
...
<tr class="databack">
	<td class="tngshadow">
		...
		<span class="optionhead">Vertical percentage for years</span>
		<p>The event timeline is split vertically into sections for years and months. This value indicates what percentage
		of the vertical space (0-100) will be used to chart years.</p>

		<span class="optionhead">Pixels between years</span>
		<p>The number of pixels that will separate each year on the year section of the event timeline. A larger value will result in a more
		focused chart.</p>

		<span class="optionhead">Years between year markers</span>
		<p>The number of years between each year marker on the year section of the event timeline. A larger value will cause the visible year markers
		to be more spread out.</p>

		<span class="optionhead">Vertical percentage for months</span>
		<p>The event timeline is split vertically into sections for years and months. This value indicates what percentage
		of the vertical space (0-100) will be used to chart months.</p>

		<span class="optionhead">Pixels between months</span>
		<p>The number of pixels that will separate each month on the month section of the event timeline. A larger value will result in a more
		focused chart.</p>
		...
		<p>Note: If too many events are on the chart at once, those at the bottom will not be visible. If you have a lot of timeline events and this is a frequent occurrence,
		you might consider increasing the Chart Height (see above).</p>
