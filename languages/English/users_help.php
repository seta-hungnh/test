...
<tr class="databack">
	<td class="tngshadow">
		...
		<p>User may use the GEDCOM tab to download a GEDCOM file from the GEDCOM tab in the public area.</p>

	    <span class="optionhead">Allow to download PDfs</span>
		<p>User may use the PDF option to create a PDF file from various pages in the public area.</p>
