...
<tr class="databack">
	<td class="tngshadow">
		...
		<strong>I</strong> is at the end, not the beginning), you can edit the prefixes.php file that came with TNG to change the convention TNG uses.</p>
		...
		<p><span class="optionhead">LDS Data (Baptism, Endowment)</span><br />
