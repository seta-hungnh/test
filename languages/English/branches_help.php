...
<tr class="databack">
	<td class="tngshadow">
		...
		<a name="what"><p class="subheadbold">What is a Branch?</p>
		A <strong>Branch</strong> is a set of individuals within a tree that all share a common label. This label allows TNG to restrict access to these labeled
...
<tr class="databack">
	<td class="tngshadow">
		...
		<p>To assign a branch label to individuals in your database, click on the <strong>Label Branches</strong> icon next to that Branch on the Search tab,
		then follow the instructions on the following page. After selecting options, click the "Add labels" button at the bottom. Items on that page include:</p>

		<span class="optionhead">Action</span>
		<p>Choose whether you'll be adding new labels or clearing out existing ones. If you're clearing labels, then you will also choose whether this action will apply to all members of your tree or just a subset.
		Depending on the options you select, different parts of the screen may disappear.</p>

		<span class="optionhead">Starting Individual</span>
		<p>If you are only applying your action to some of the people in your database, enter or find the ID of the individual with whom your branch begins. All
		...
		later by repeating this process and picking a different "Starting Individual".</p>
		...
		<span class="optionhead">Label Branches</span>
		<p>Click this button to apply labels to the selected individuals. Note: You may
		also apply branch labels one person or family at a time in the People and Families sections of the Admin
		interface.</p>
